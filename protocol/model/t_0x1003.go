...
type T0x1003 struct {
	...
	// EnterAudioSampleRate 输入音频采样率
	EnterAudioSampleRate byte `json:"enterAudioSampleRate"`
	// EnterAudioSampleDigits 输入音频采样位数
...
func (t *T0x1003) String() string {
	return strings.Join([]string{
		...
		fmt.Sprintf("\t[%02x] 输入音频采样率:[%d]", t.EnterAudioSampleRate, t.EnterAudioSampleRate),
		fmt.Sprintf("\t[%02x] 输入音频采样位数:[%d]", t.EnterAudioSampleDigits, t.EnterAudioSampleDigits),
