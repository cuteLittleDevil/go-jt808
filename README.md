...
- 受“[飞哥单机 TCP 百万并发](https://github.com/yanfeizhang/coder-kung-fu)”启发
...
![go-jt808 项目包架构总览](./docs/architecture-overview.svg)
...
### 10. 自定义协议扩展 [自定义附加](./example/protocol/custom_parse/main.go) [自定义回复映射](./example/protocol/custom_active_respond/main.go)
``` txt
