...
### 1. web服务 [apifox文档](https://vsh9jdgg5d.apifox.cn/) [web详情](./example/web/README.md)
``` txt
...
| 流媒体服务 | 语言 | 描述       | 说明 |
|----------|-----|-------------------|-----|
| RTVS | 不开源<br/> 可使用  | 在线测试页面 http://49.234.235.7:17001 <br/> 点击实时视频(0x9101)播放| [详情点击](./example/jt1078/README.md#rtvs)  |
